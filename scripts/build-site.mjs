...
const BASE = "https://appky.github.io/einvoice";
...
${JSON.stringify({
  ...
  description,
  url: BASE + "/",
  softwareHelp: "https://github.com/Appky/einvoice",
...
<footer class="site">
  <div class="wrap">
    ...
    <div><a href="https://github.com/Appky/einvoice">Source &amp; issues</a> · <a href="https://www.npmjs.com/package/einvoice-kit">npm</a></div>
  </div>
</footer>
${scripts}
</body>
...
<p>The EN 16931 business rules: mandatory fields (BR-*), totals arithmetic (BR-CO-*), decimal precision (BR-DEC-*), all ten VAT category rule groups (standard, zero, exempt, reverse charge, intra-community, export, IGIC, IPSI, not-subject, split payment) and the code list rules (BR-CL-*) — about 165 rules. National extensions such as XRechnung's BR-DE rules are on the <a href="https://github.com/Appky/einvoice#roadmap">roadmap</a>.</p>
